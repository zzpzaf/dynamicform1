    ...
    validators: [
      {
        validatorName: 'required',
        validator: Validators.required,
        validatorErrorMessage: 'The Model Year field is required.',
      },
      {
        validatorName: 'min',
        validator: Validators.min(2005),
        validatorErrorMessage: 'The Model Year field must be at least 2005.',
      },
      {
        validatorName: 'max',
        validator: Validators.max(2030),
        validatorErrorMessage:
          'The Model Year field must be no more than 2030.',
      },
    ],
  },
  {
